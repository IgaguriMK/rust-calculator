...
impl Expression {
    ...
    fn new_box_number(n: i64) -> Box<Expression> { Box::new(Expression::Number(n)) }
    fn  new_box_add(l: Box<Expression>, r: Box<Expression>) -> Box<Expression> { Box::new(Expression::Add(l, r))}
    fn  new_box_sub(l: Box<Expression>, r: Box<Expression>) -> Box<Expression> { Box::new(Expression::Sub(l, r))}
    fn new_box_mult(l: Box<Expression>, r: Box<Expression>) -> Box<Expression> { Box::new(Expression::Mult(l, r))}
    fn  new_box_div(l: Box<Expression>, r: Box<Expression>) -> Box<Expression> { Box::new(Expression::Div(l, r))}
    fn  new_box_mod(l: Box<Expression>, r: Box<Expression>) -> Box<Expression> { Box::new(Expression::Mod(l, r))}
    fn  new_box_pow(l: Box<Expression>, r: Box<Expression>) -> Box<Expression> { Box::new(Expression::Pow(l, r))}
...
mod test {
    ...
    fn build_expression_tree_add() {
        ...
        assert_eq!(expr,
                    Expression::new_box_add(
                       Expression::new_box_number(1),
                       Expression::new_box_number(2)
                    )
                );
    }
